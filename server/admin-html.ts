...
<body>
  ...
  <script>
    ...
    const productionOrigin = 'https://citizen-witness--lanframeit.replit.app';
    ...
    initTheme();
    loadReports();
    // Auto-refresh is intentionally disabled so the map does not reset while investigating.
  </script>
</body>
</html>`;
